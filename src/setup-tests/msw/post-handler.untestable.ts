...
export const postHandlers: RestHandler[] = [
  ...
  rest.post('https://jsonplaceholder.typicode.com/posts', (_, res, ctx) =>
    res(
      ctx.status(201),
      ctx.json({
        id: 101,
  ...
  rest.delete('https://jsonplaceholder.typicode.com/posts/1', (_, res, ctx) =>
    res(ctx.status(204), ctx.json({})),
  ),
  rest.get('https://jsonplaceholder.typicode.com/posts/2', (_, res, ctx) =>
    res(ctx.status(200), ctx.json(posts[1])),
  ),
  rest.put('https://jsonplaceholder.typicode.com/posts/2', (_, res, ctx) =>
    res(
      ctx.status(200),
      ctx.json({
        id: 2,
